...
#def spherical2cartesian(results: GazeResultContainer, frame):
#    # Draw bounding boxes
#    for bbox in results.bboxes:
#        frame = draw_bbox(frame, bbox)
#
...
#        bbox_height = y_max - y_min
#        
#        def draw_gaze2(a,b,c,d,image_in, pitchyaw, thickness=2, color=(255, 255, 0),sclae=2.0):
#            image_out = image_in
#            (h, w) = image_in.shape[:2]
#            length = c
#            pos = (int(a+c / 2.0), int(b+d / 2.0))
...
#
#        x,y = draw_gaze2(x_min,y_min,bbox_width, bbox_height,frame,(pitch,yaw),color=(0,0,255))
#        
#
#    return x,y
#